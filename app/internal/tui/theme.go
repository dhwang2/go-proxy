...
var (
	...
	ColorLabel       = lipgloss.Color("#ABB2BF") // One Dark foreground (warm-tinted)
	ColorLabelDim    = lipgloss.Color("#7F848E") // Dimmed label (unfocused panel)
	...
	ColorMuted       = lipgloss.Color("#5C6370") // One Dark comment (hints, separators)
